...
ActiveRecord::Schema[8.0].define(version: 2026_07_30_163805) do
  ...
  create_table "filter_categories", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "name"
    t.bigint "filter_category_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.boolean "multivalued"
    t.index ["filter_category_id"], name: "index_filter_categories_on_filter_category_id"
  end

  create_table "gender_product_types", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "gender_id", null: false
    t.bigint "product_type_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["gender_id"], name: "index_gender_product_types_on_gender_id"
    t.index ["product_type_id"], name: "index_gender_product_types_on_product_type_id"
  end
  ...
  create_table "product_type_filter_categories", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "product_type_id", null: false
    t.bigint "filter_category_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["filter_category_id"], name: "index_product_type_filter_categories_on_filter_category_id"
    t.index ["product_type_id"], name: "index_product_type_filter_categories_on_product_type_id"
  end
  ...
  create_table "shopping_carts", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.index ["size_id"], name: "index_shopping_carts_on_size_id"
  ...
  add_foreign_key "filter_categories", "filter_categories"
  add_foreign_key "gender_product_types", "genders"
  add_foreign_key "gender_product_types", "product_types"
  add_foreign_key "product_type_filter_categories", "filter_categories"
  add_foreign_key "product_type_filter_categories", "product_types"
